...
namespace EasyTalkWeb.Migrations
{
    ...
    [Migration("20240415121339_addTechnologiesRelations")]
    partial class addTechnologiesRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPostTechnology", b =>
                {
                    ...
                    b.HasKey("JobpostsId", "TechnologiesId");

                    b.HasIndex("TechnologiesId");

                    b.ToTable("JobPostTechnology");
                });
            ...
            modelBuilder.Entity("ProposalTechnology", b =>
                {
                    ...
                    b.HasKey("ProposalsId", "TechnologiesId");

                    b.HasIndex("TechnologiesId");

                    b.ToTable("ProposalTechnology");
                });
            ...
            modelBuilder.Entity("JobPostTechnology", b =>
                {
                    b.HasOne("EasyTalkWeb.Models.JobPost", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProposalTechnology", b =>
                {
                    b.HasOne("EasyTalkWeb.Models.Proposal", null)
                        .WithMany()
